...
class _UserDataSource implements UserDataSource {
  ...
  @override
  Future<UserPrefs> getUserPrefs(userId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<UserPrefs>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = UserPrefs.fromJson(_result.data!);
    return value;
  }
  ...
  @override
  Future<HttpResponse<dynamic>> updateSystem({
    required userId,
    required payload,
  }) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<HttpResponse<dynamic>> sendResetPassword(payload) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
