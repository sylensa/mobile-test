...
abstract class $RemoteCopyWith<$Res> {
  factory $RemoteCopyWith(Remote value, $Res Function(Remote) then) =
      _$RemoteCopyWithImpl<$Res, Remote>;
  @useResult
  $Res call(
      {String id,
      String deviceId,
...
/// @nodoc
class _$RemoteCopyWithImpl<$Res, $Val extends Remote>
    implements $RemoteCopyWith<$Res> {
...
/// @nodoc
class __$$_RemoteCopyWithImpl<$Res>
    extends _$RemoteCopyWithImpl<$Res, _$_Remote>
...
/// @nodoc
@JsonSerializable()
class _$_Remote with DiagnosticableTreeMixin implements _Remote {
  const _$_Remote(
      {required this.id,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Remote(id: $id, deviceId: $deviceId, deviceName: $deviceName, parentId: $parentId, farmId: $farmId, unitType: $unitType, systemType: $systemType, geolocation: $geolocation, isActive: $isActive, channels: $channels, ioGroups: $ioGroups)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'Remote'))
...
abstract class _Remote implements Remote {
  const factory _Remote(
      ...
      final List<IoGroup> ioGroups}) = _$_Remote;
